...
class Simulation {
public:
	Simulation(double b, double z, double p, double q, Network& sirv, Network& opinion, int size,
			std::mt19937& mt, std::uniform_int_distribution<int> neighbor_dist[18], std::string filename);
	virtual ~Simulation();
